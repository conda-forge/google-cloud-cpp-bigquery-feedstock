About google-cloud-cpp-bigquery-feedstock
=========================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/google-cloud-cpp-bigquery-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-cloud-cpp-bigquery-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libgoogle-cloud-bigquery libgoogle-cloud-bigquery-devel
# for installing globally
pixi global install libgoogle-cloud-bigquery libgoogle-cloud-bigquery-devel
```
...
It is possible to list all of the versions of `libgoogle-cloud-bigquery` available on your platform:
...
```
pixi search libgoogle-cloud-bigquery --channel conda-forge
```
